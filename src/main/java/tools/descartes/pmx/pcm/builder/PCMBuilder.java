...
public class PCMBuilder extends ModelBuilder implements IModelBuilder {
	...
	private void loadPrimitiveDataTypes() {
		...
		//resource = resourceSet.createResource(URI.createFileURI(outputDir+"/PrimitiveTypes.repository"));
		//resource = resourceSet.getResource(URI.createFileURI(outputDir+"/PrimitiveTypes.repository"), true);
		...
		resource = resourceSet.createResource(URI.createFileURI("C:\\Users\\ptreyer\\eclipse-workspace\\pmx_pcm_fzi-pmxupgrade\\pmx-pcm\\tools.descartes.pmx.pcm.builder\\PrimitiveTypes.repository"));
		resource = resourceSet.getResource(URI.createFileURI("C:\\Users\\ptreyer\\eclipse-workspace\\pmx_pcm_fzi-pmxupgrade\\pmx-pcm\\tools.descartes.pmx.pcm.builder\\PrimitiveTypes.repository"), true);
		...
		try {
			...
			for (DataType dataType : dataTypeRepository.getDataTypes__Repository()) {
				dataTypeMap.put(((PrimitiveDataType) dataType).getType().getName(), (EObject) dataType);
			}
		} catch (IOException e) {
	...
	private void loadPalladioResourceRepository() {
		...
		//resource = resourceSet.createResource(URI.createFileURI(outputDir+"/Palladio.resourcetype"));
		//resource = resourceSet.getResource(URI.createFileURI(outputDir+"/Palladio.resourcetype"), true);
		
		resource = resourceSet.createResource(URI.createFileURI("C:\\Users\\ptreyer\\eclipse-workspace\\pmx_pcm_fzi-pmxupgrade\\pmx-pcm\\tools.descartes.pmx.pcm.builder\\Palladio.resourcetype"));
		resource = resourceSet.getResource(URI.createFileURI("C:\\Users\\ptreyer\\eclipse-workspace\\pmx_pcm_fzi-pmxupgrade\\pmx-pcm\\tools.descartes.pmx.pcm.builder\\Palladio.resourcetype"), true);
	...
	public EObject connectAssemblies(String providingAssemblyName, String requiringAssemblyName) {
		...
		return (EObject) assemblyConnector;
	}
	...
	public EObject createAssembly(String assemblyName) {
		...
		return (EObject) assemblyContext;
	}
	...
	public EObject createAllocation(String assemblyName, String hostName) {
		...
		return (EObject) allocationContext;
	}
	...
	public EObject createMethod(ComponentType type, Signature signature) {
		...
		return (EObject) operationSignature;
	}
	...
	private DataType addDataType(String name) {
		...
		if (!dataTypeMap.containsKey(name)) {
			dataTypeMap.put(name, (EObject) createDataType(name, repository));
		}
	...
	public EObject createHost(String hostName, int numCores) {
		...
		return (EObject) resourceContainer;
	}
